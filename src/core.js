...
BoldReportComponents = (function () {
    ...
    BoldReportComponents.bindAndRaiseEvent = function (instance, model, event) {
        if (!event.startsWith('model.')) {
            ...
            var originalEvt = event.startsWith('bold') ? event.substr(4) : event;
    ...
    BoldReportComponents.prototype.ngAfterContentInit = function () {
        ...
        if (events) {
            for (var i = 0; i < events.length; i++) {
                ...
                BoldReportComponents.bindAndRaiseEvent(this, model, event_1);
            }
        }
        if (ej.isNullOrUndefined(this['options'])) {
    ...
    BoldReportComponents.prototype.ngAfterViewInit = function () {
        ...
        var controlName = this.lowerCaseFirstLetter(this.controlName);
...
exports.BoldReportComponents = BoldReportComponents;
...
var ArrayTagElement = (function () {
    ...
    // TODO: Need to consider dynamic child change
    ArrayTagElement.prototype.ngAfterContentInit = 
    // TODO: Need to consider dynamic child change
    function () {
        var _this = this;
        var index = 0;
